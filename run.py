...
# **** SETUP ****
run_name = 'test' # change this as you want
OS = utils.setup(
	write_parent = 'local/runs/',   # will save all files to this parent folder
...
make_new_configuration = True # set this to false to read in an old configuration from file
write_configuration_path = working_directory + 'configuration.json' # specify where to write this configuration to (will rewrite if path exists)
read_configuration_path = working_directory + 'configuration.json' # if make_new_configuration=False then specify where to read it from

# MAKE NEW CONFIGURATION AND COMPONENTS
