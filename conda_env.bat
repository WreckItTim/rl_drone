...
python -m pip install --force-reinstall -v "future==0.18.3"
python -m pip install --force-reinstall -v "imageio==2.24.0"
python -m pip install --force-reinstall -v "importlib-metadata==4.13.0"
python -m pip install --force-reinstall -v "kiwisolver==1.4.4"
python -m pip install --force-reinstall -v "msgpack-python==0.5.6"
python -m pip install --force-reinstall -v "networkx==3.0"
python -m pip install --force-reinstall -v "opencv-contrib-python==4.7.0.68"
python -m pip install --force-reinstall -v "packaging==23.0"
python -m pip install --force-reinstall -v "pandas==1.5.2"
python -m pip install --force-reinstall -v "Pillow==9.4.0"
python -m pip install --force-reinstall -v "py4j==0.10.9.7"
python -m pip install --force-reinstall -v "pyparsing==3.0.9"
python -m pip install --force-reinstall -v "python-dateutil==2.8.2"
python -m pip install --force-reinstall -v "pytz==2022.7.1"
python -m pip install --force-reinstall -v "PyWavelets==1.4.1"
